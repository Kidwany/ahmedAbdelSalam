                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <textarea class="form-control" name="description_ar" id="exampleInputEmail1" placeholder="ادخل  السيرة الذاتية للعضو" rows="6" >{{$member->team_ar->description}}</textarea>
